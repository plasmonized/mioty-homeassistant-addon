...
class WebGUI:
    ...
    def setup_routes(self):
        ...
        def index():
            ...
            if index_exists:
                logging.info("✅ Verwende AKTUELLE index.html Template-Datei (Version 1.0.5.6.22)")
...
<head>
    ...
    <title>mioty Application Center für Homeassistant v1.0.5.6.16</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<head>
    ...
    <meta http-equiv="Pragma" content="no-cache">
    <meta http-equiv="Expires" content="0">
    <title>mioty Application Center Einstellungen v1.0.5.6.9</title>
    <style>
        * {
            margin: 0;
            padding: 0;

...
**Version: 1.0.5.7.9** - NEW FEATURE: Integrated IoddProcessParser for automated IODD interpretation. Added IO-Link Adapter management with IODD assignment per adapter. New Decoder page with 3 sections: Decoder, IO-Link Adapter, IODD Management.

...
function decode(dataBytes, metadata) {
    ...
    if (ver_min < 3) {
        ...
        if (ver_min == 1) {
            if (result.status === 1 && dataBytes.length >= 140) {
                ...
                result.e_t1_a_i = val(fetchUint64(true), "Wh");
                result.e_t2_a_i = val(fetchUint64(true), "Wh");
                result.e_t1_a_e = val(fetchUint64(true), "Wh");
                result.e_t2_a_e = val(fetchUint64(true), "Wh");
                result.e_t1_r_i = val(fetchUint64(true), "Wh");
                result.e_t2_r_i = val(fetchUint64(true), "Wh");
                result.e_t1_r_e = val(fetchUint64(true), "Wh");
                result.e_t2_r_e = val(fetchUint64(true), "Wh");
                result.i_l1 = val(fetchSint32(true), "mA");
                result.i_l2 = val(fetchSint32(true), "mA");
                result.i_l3 = val(fetchSint32(true), "mA");
                result.i_l4 = val(fetchSint32(true), "mA");
                result.i_l123 = val(fetchSint32(true), "mA");
                result.p_l1_a = val(fetchSint32(true), "W");
                result.p_l2_a = val(fetchSint32(true), "W");
                result.p_l3_a = val(fetchSint32(true), "W");
                result.p_l123_a = val(fetchSint32(true), "W");
                result.p_l123_a_avg = val(fetchSint32(true), "W");
                result.u_l1 = val(fetchSint32(true) / 10, "V");
                result.u_l2 = val(fetchSint32(true) / 10, "V");
                result.u_l3 = val(fetchSint32(true) / 10, "V");
                result.f = val(fetchSint16(true) / 10, "Hz");
                index += 16;
                result.pf_l1 = fetchSint8(true) / 10;
                result.pf_l2 = fetchSint8(true) / 10;
                result.pf_l3 = fetchSint8(true) / 10;
            } else if (result.status === 2) {
                result.e_ta_a_i = val(fetchUint64(false), "Wh");
                result.e_ta_a_e = val(fetchUint64(false), "Wh");
            }
        } else if (ver_min == 2) {
            if (result.status === 1) {
                result.p_l1_a = val(fetchSint32(false), "W");
                result.p_l2_a = val(fetchSint32(false), "W");
                result.p_l3_a = val(fetchSint32(false), "W");
                result.p_l123_a = val(fetchSint32(false), "W");
                result.i_l1 = val(fetchSint32(false), "mA");
                result.i_l2 = val(fetchSint32(false), "mA");
                result.i_l3 = val(fetchSint32(false), "mA");
                result.i_l123 = val(fetchSint32(false), "mA");
                result.u_l1 = val(fetchSint32(false) / 10, "V");
                result.u_l2 = val(fetchSint32(false) / 10, "V");
                result.u_l3 = val(fetchSint32(false) / 10, "V");
                result.e_ta_a_i = val(fetchUint64(false), "Wh");
                result.e_ta_a_e = val(fetchUint64(false), "Wh");
                result.e_ta_r_i = val(fetchUint64(false), "Wh");
                result.e_ta_r_e = val(fetchUint64(false), "Wh");
                result.pf_l1 = fetchSint8(false) / 100;
                result.pf_l2 = fetchSint8(false) / 100;
                result.pf_l3 = fetchSint8(false) / 100;
                result.f = val(fetchSint16(false) / 10, "Hz");
    ...
    if (result.status === 1) {
        ...
        result.i_l123 = val(fetchSint32(true), "mA");
        index = 84;
        result.e_ta_a_i = val(fetchUint64(true), "Wh");
        return result;
    }
    ...
    if (result.payload_profile === 0) {
        ...
        result.u_l2 = val(fetchSint32(false) / 10, "V");
        result.u_l3 = val(fetchSint32(false) / 10, "V");
        result.u_l12 = val(fetchSint32(false) / 10, "V");
        result.u_l23 = val(fetchSint32(false) / 10, "V");
        result.u_l31 = val(fetchSint32(false) / 10, "V");
        result.e_ta_a_i = val(fetchUint64(false), "Wh");
        result.e_ta_a_e = val(fetchUint64(false), "Wh");
        result.e_ta_r_i = val(fetchUint64(false), "Wh");
        result.e_ta_r_e = val(fetchUint64(false), "Wh");
